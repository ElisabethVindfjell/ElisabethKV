...
# splitting container int two columns:
with st.container():
    c1, c2 = st.columns(2)
    with c1:
        st.image("assets/h4.jpg", use_column_width=True)
    with c2:
        st.markdown("""Hello there! My Name is Elisabeth Vindfjell. This webpage serves as an interactive resume, 
                    providing you with valuable insights into my background and expertise.
        ...
        st.markdown("""I am a student currently pursuing a master's degree in economics with a love for coding and problem-solving. Through this platform,
                    I aim to present my skillset in Python and Streamlit. In addition to my proficiency in Python, I am well-versed in coding with R and have
                    experience utilizing Python's Dash framework. You can read more about me and my experience in the 'About me'-page located in the sidebar.""")
...
# buttons that link to my github and linkedin
